...
def gu(stock,stock_price,stock_num,price_change):
    ...
    stock = ['股票A','股票B','股票C']
    #随机生成三个股票价格
    stock_price = [random.randint(1,100),random.randint(1,100),random.randint(1,100)]
    #随机生成三个股票数量
    stock_num = [random.randint(1,10),random.randint(1,10),random.randint(1,10)]
    #价格每秒随机增减
    price_change = [random.randint(-1,1),random.randint(-1,1),random.randint(-1,1)]
    #股票数量每秒随机增减
